      ...
      >
        ...
        <View style={styles.modeRow}>
          {RECOVERY_MODE_OPTIONS.map((option) => (
            <Pressable
              key={option.value}
              onPress={() => option.implemented && setMode(option.value)}
              style={[
                styles.modeChip,
            ...
            <View style={styles.card}>
              ...
              {screen === "DETAIL" && selectedMeeting ? (
                <View style={styles.meetingCard}>
                  ...
                  <Text style={styles.sectionMeta}>{selectedMeeting.address}</Text>
                  <Text style={styles.sectionMeta}>
                    {selectedMeeting.startsAtLocal} • {selectedMeeting.openness} •{" "}
