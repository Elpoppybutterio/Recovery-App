...
- Participant compliance backend foundation: Postgres-backed participant profiles, obligations, compliance events, and violations now provide shared operational truth for mobile participant flows and future org/court dashboard filtering without relying on local-only state.
