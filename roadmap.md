...
- Setup-state persistence hardening: iOS/dev cold launches now hydrate saved setup/profile state before any default writes, skip premature overwrite until hydration completes, and fall back safely when stored setup payloads are invalid.
